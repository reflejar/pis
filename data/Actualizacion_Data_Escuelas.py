...
establec_educativos_completo=gpd.read_file("./data/escuelas_en_parcelas.geojson")
...
establec_educativos_completo[VAR_CODIGO_UNICO] = establec_educativos_completo['código.postal'].fillna(0).astype(int).astype(str)+ ' - ' +  establec_educativos_completo[VAR_CUE].astype(str) + ' - ' + establec_educativos_completo['sede.axo.ext']
...
base_escuelas_actualizada_gsjon.to_file('./data/escuelas_informacion_actualizadas.geojson', driver='GeoJSON')
