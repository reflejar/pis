...
localidades=gpd.read_file("./Inputs/Localidades.geojson")
...
localidades_excl.to_parquet("./localidades_excl.parquet")
localidades_amort.to_parquet("./localidades_amort.parquet")


#Parajes
parajes=gpd.read_file("./Inputs/Parajes.geojson")
...
parajes_excl.to_parquet("./parajes_excl.parquet")
parajes_amort.to_parquet("./parajes_amort.parquet")
...
#Agregar datos de poblacion
poblacion=pd.read_excel("./Inputs/Base de Datos - Mar Chiquita.xlsx")
poblacion["Nombre de localidad/poblado"].isin(localidades_parajes["Name"])
poblacion["Name"]=poblacion["Nombre de localidad/poblado"]
poblacion=poblacion.drop_duplicates(subset=['Name'])

localidades_parajes=pd.merge(localidades_parajes,poblacion,on="Name",how="left")
localidades_parajes["Habitantes"]=localidades_parajes["Habitantes"].fillna("-")
localidades_parajes["Habitantes"] = localidades_parajes["Habitantes"].astype(str).replace('\.0', '', regex=True)
localidades_parajes.to_parquet("./localidades_parajes.parquet")
...
escuelas_en_parcelas = gpd.read_file("./Inputs/escuelas_en_parcelas.geojson")
...
cursos=gpd.read_file("./Inputs/cursos_agua.geojson")
...
localidades_excl=gpd.read_parquet("./localidades_excl.parquet")
localidades_amort=gpd.read_parquet("./localidades_amort.parquet")
parajes_excl=gpd.read_parquet("./parajes_excl.parquet")
parajes_amort=gpd.read_parquet("./parajes_amort.parquet")
escuelas_parcelas_excl=gpd.read_parquet("./escuelas_parcelas_excl.parquet")
escuelas_parcelas_amort=gpd.read_parquet("./escuelas_parcelas_amort.parquet")
cuerpos_excl=gpd.read_parquet("./cuerpos_excl.parquet")
cursos_excl=gpd.read_parquet("./cursos_excl.parquet")

cuerpos=gpd.read_parquet("./cuerpos.parquet")
localidades_parajes=gpd.read_parquet("./localidades_parajes.parquet")
escuelas_parcelas=gpd.read_parquet("./escuelas_parcelas.parquet")
reservas=gpd.read_parquet("./reservas.parquet")
...
total_excl.to_parquet("./total_excl.parquet")
total_amort.to_parquet("./total_amort.parquet")
...
reservas=gpd.read_file("./Inputs/Reservas.geojson")
...
reservas.to_parquet("./reservas.parquet")

#Transformar a json (para mapa) y guardar
reservas_geojson=json.loads(reservas.to_json(na="keep"))
with open('./reservas_geojson.pkl', 'wb') as f:
...
cursos=gpd.read_file("./Inputs/cursos_agua.geojson")
cursos.to_parquet("./cursos_agua.parquet")
