            ...
            <div className="columns is-vcentered">
                ...
                <div className="column is-offset-1 is-3">
                    <ul>
                            ...
                            <li><a className="footer-link" href="https://democraciaos.org/es/#nosotros">{intl.formatMessage({ id: "us.title" })}</a></li>
                            <li>
                            <PopupButton id="bkXtFW" className="button is-rounded is-medium is-dark" rel="noopener noreferrer">{intl.formatMessage({ id: "donate" })}</PopupButton>
                            </li>
