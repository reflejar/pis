...
Proximamente = html.Section([
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        html.P("Conocé los resultados de la campaña de testeos en orina y análisis en el ambiente para saber dónde y en qué medida se detectaron trazas de agroquímicos.", className="text-white px-5")
                    ...
                    dbc.Col([
                        ...
                        html.P("Conocé en qué puesto del ranking normativo está la regulación de agroquímicos de tu territorio para saber cómo puede mejorar.", className="text-white px-5")
                    ], 
                    lg=3),
                ], class_name="px-5"),
                dbc.Row([
                    dbc.Col([
                        ...
                        html.P("Descubrí el compendio de todos los fallos judiciales sobre el tema para saber en cuáles te podés apoyar y así exigir cambios.", className="text-white px-5")
                    ...
                    dbc.Col([
                        ...
                        html.P("Desde una georreferenciación, conocé las restricciones municipales a las aplicaciones de agroquímicos para saber cuál está vigente en el lugar en que vivís.", className="text-white px-5")
                    ], 
                    lg=3),
                ], class_name="px-5"),                
